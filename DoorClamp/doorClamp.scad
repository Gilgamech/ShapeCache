...
//screw handles
gCylinder(betweenSpace-4,1,1,-10,0,0,0,90,0);//worm screw stand ins
}}
...
gCube(thickness/2,len-height+.5,betweenSpace/2,
    xMove-5,yMove-height/2+.25,zMove+2.25,
    xRot,90);//center panel
}
